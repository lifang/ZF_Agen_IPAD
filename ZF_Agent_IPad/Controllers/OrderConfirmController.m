...
- (void)getAddressList {
    ...
    [NetworkInterface getAddressListWithToken:delegate.token usedID:@"" finished:^(BOOL success, NSData *response) {
...
//    ensureButton.layer.cornerRadius = 4.f;
    ...
    [ensureButton setBackgroundImage:kImageName(@"blue") forState:UIControlStateNormal];
